...
typedef struct CPU_State_Struct {
	...
	uint32_t ID_EX_IMM;
	unsigned char ID_EX_REG_DEST;
	unsigned char ID_EX_MEM_WRITE;
	unsigned char ID_EX_MEM_READ;
	unsigned char ID_EX_ALU_OP;
	unsigned char ID_EX_ALU_SRC;
	unsigned char ID_EX_BRANCH;
	unsigned char ID_EX_JMP;
	unsigned char ID_EX_REG_WRITE;
	unsigned char ID_EX_MEMTOREG;
	...
	unsigned char MEM_WB_REG_WRITE_FORWARD;
